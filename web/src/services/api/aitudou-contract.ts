...
const GENERAL_OPERATIONS: AitudouOperationDefinition[] = [
    ...
    },
    {
        ...
        group: "general",
        label: "视频生成",
        description: "Seedance、HappyHorse、Wan、Kling、Hailuo、Vidu、FLUX 3 Video 与 Jinyu 视频模型统一入口。",
        method: "POST",
        path: "/v1/videos",
        requestMode: "json",
    ...
    },
    {
        ...
        group: "general",
        label: "视频超分",
        description: "Jinyu Upscaler；连接一个视频，选择目标分辨率。",
        method: "POST",
        path: "/v1/videos",
        requestMode: "json",
        requiredFields: ["model", "metadata.content"],
        defaultPayload: { model: "jinyu-upscaler", metadata: { resolution: "1080p", content: [{ type: "video_url", video_url: { url: "@Video 1" } }] } },
        taskFamily: "video",
        outputHint: "video",
        docsAnchor: "upscaler",
    },
    {
        ...
        group: "general",
        label: "图片生成 / 编辑",
        description: "Seedream、Qwen-Image 与 Jinyu 图片模型统一入口。",
        method: "POST",
