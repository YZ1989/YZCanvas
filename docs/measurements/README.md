...
## YZCanvas 0.1.1 图标与启动页更新

最新安装包 3,764,594 字节（约 3.59 MiB），原生 exe 12,418,048 字节，前端 dist 2,508,574 字节；安装包比原版基线减少 26.7%。上方 0.1.0 表格保留作历史比较，`yzcanvas.json` 对应最新 0.1.1。
