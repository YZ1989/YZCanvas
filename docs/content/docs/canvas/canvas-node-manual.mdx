...
To generate an image from text, prepare the prompt and select **Generate Image**. YZCanvas creates and connects a generation configuration node, starts generation, and lets you adjust the model, aspect ratio, and output count before retrying.
