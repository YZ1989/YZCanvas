...
description: Build and deploy YZCanvas from local source with Docker Compose
---
...
After the image has been built as `yzcanvas:local`, the default Compose file can start it again without rebuilding:
