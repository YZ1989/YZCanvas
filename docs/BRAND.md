...
新建画布按钮使用酒红皮革、黄铜双边框和实体底座，已有 Noto Serif SC 字集呈现烫金感宋体；导航纸牌、相片装裱、内凹搜索框及工具浮层采用一致的光照方向与深浅主题阴影。动效只在交互时触发，支持减少动态效果。

- 资源：`web/public/brand/oxblood-leather.webp`，384×384，22,312 字节，由内置 Image Gen 生成后压缩。
- 生成提示摘要：平面正视、可平铺的细颗粒酒红古董书皮，英式复古摄影器材皮箱质感，均匀照明，无物体、接缝、文字、装饰边框。
- 复用原字体，无新依赖；工作台位图与字体累计约 179KB。仅更新源码与开发预览，不重新打包。
