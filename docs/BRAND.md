...
`web/public/brand/workspace-hero.webp`：原创 AI 生成的创作主题插画，1000×500 WebP，83,236 字节。构图参考用户提供的工作台截图，重新生成戴眼镜的柯基与绘图板，使用黄、橙、青绿的插画配色；不含上游品牌标识。YZCanvas 标识仍复用现有 SVG。
